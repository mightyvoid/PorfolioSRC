...
const LeftBar = (props) => {
  ...
  const WebList = () => (
    <div>
      <a href="/Weather.js">
        <div className="msl-12 flex items-center hover:cursor-pointer hover:bg-opacity-80 hover:bg-[#2b2a2a] w-60">
      ...
      <div>
        ...
        <div className="absolute inset-x-0 bottom-10 ">
          <div className="flex px-6 space-x-7">
            <a href="https://github.com/mightyvoid" target={"_blank"}>
              <img
                src={GitLogo}
                alt="Git Logo"
            ...
            <a href="https://www.linkedin.com/in/navinravindran/" target={"_blank"}>
              <img
                src={LinkedinLogo}
                alt="Linkedin Logo"
                className="h-10 w-10 text-yellow_vs hover:cursor-pointer hover:h-12 hover:w-12"
            ...
            <a href="mailto:navinanbumech@gmail.com" target={"_blank"}>
              <img
                src={MailLogo}
                alt="Mail Logo"
                className="h-10 w-10 text-yellow_vs hover:cursor-pointer hover:h-12 hover:w-12"
